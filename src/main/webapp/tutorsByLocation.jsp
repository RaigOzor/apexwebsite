                            ...
                            <div class="div-container" id="schoolPackages">
                                <div class="custom-div">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="package-details" id="onceDiscountDiv">10% disocunt<br><del id="onceDiscount">Original Price</del></div>
                                ...
                                <div class="custom-div">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="package-details" id="basicDiscountDiv">10% disocunt<br><del	id="basicDiscount">Original Price</del></div>
                                ...
                                <div class="custom-div">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="package-details" id="premiumDiscountDiv">10% disocunt<br><del id="premiumDiscount">Original Price</del></div>
                                ...
                                <div class="custom-div">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="package-details" id="advancedDiscountDiv" >10% disocunt<br><del id="advancedDiscount">Original Price</del></div>
                                ...
                                <div class="custom-div">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="package-details" onclick="advanceElite()">Package Details</div>
                                        <div class="package-details" id="eliteDiscountDiv">10% disocunt<br><del id="eliteDiscount">Original Price</del></div>
                                ...
                                <div class="custom-div">
                                    <p>Apex Package</p>
                                    <div class="content">
                                        <div class="session-per-month">20 Sessions per month<br>(5 times a week)</div>
                                        <div class="package-details">Package Details</div>
                                        <div class="package-details" id="apexDiscountDiv">10% disocunt<br><del id="apexDiscount">Original Price</del></div>
                                        <button type="submit" class="package-btn" id="apexPackage">Select</button>
                                    </div>
                                </div>
				...
				if (forWho === "school") {
					...
					if (ghg === "Online" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
						...
						if (ghg === "Online" && (syllabusId === "IB")) {
							...
							const apexPackage = document.getElementById('apexPackage');
							apexPackage.textContent = 'R7800'; // or button.innerHTML = 'Submit';
							...
							//	apexDiscountDiv.style.display = 'block';
								...
								const basicPackage = document.getElementById('basicPackage');
								basicPackage.textContent = '1755'; // or button.innerHTML = 'Submit';
								/*const basicDiscount = document.getElementById('basicDiscount');
								...
								if (ghg === "In Person" && (syllabusId === "IB")) {
									...
									const apexPackage = document.getElementById('apexPackage');
									apexPackage.textContent = 'R10620'; // or button.innerHTML = 'Submit';
									...
									if (ghg === "Online" && (syllabusId === "Cambridge" || syllabusId === "Pearson Edexcel")) {
										...
										const elitePackage = document.getElementById('elitePackage');
										elitePackage.textContent = 'R5625'; // or button.innerHTML = 'Submit';
										const eliteDiscount = document.getElementById('eliteDiscount');
										eliteDiscount.textContent = 'R6250';
										
										const apexPackage = document.getElementById('apexPackage');
										apexPackage.textContent = 'R7020'; // or button.innerHTML = 'Submit';
										const apexDiscount = document.getElementById('apexDiscount');
										apexDiscount.textContent = 'R7800';
...
document.addEventListener('DOMContentLoaded', (event) => {
	...
	function handleButtonClick(event) {
				...
				switch (buttonId) {
					case 'onceOffPackage':
						...
						if (ghg === "Online" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
							amountTopay = '270'; // amount to pay; i changed R300 to R10 for testing
						}
						else {
							...
							if (ghg === "Online" && (syllabusId === "IB")) {
								...
								if (ghg === "In Person" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
									...
									if (ghg === "In Person" && ( syllabusId === "IB")) {
										...
										if (ghg === "Online" && (syllabusId === "Cambridge" || syllabusId === "Pearson Edexcel")) {
											amountTopay = '1395'; // amount to pay;
					...
					case 'advancedPackage':
						...
						if (ghg === "Online" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
							amountTopay = '2925'; // amount to pay;
						}
						else {
							if (ghg === "Online" && (syllabusId === "IB")) {
					...
					case 'elitePackage':
						...
						if (ghg === "Online" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
							amountTopay = '3915'; // amount to pay;
						}
						else {
							if (ghg === "Online" && (syllabusId === "IB")) {
								...
								if (ghg === "In Person" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
									...
									if (ghg === "In Person" && ( syllabusId === "IB")) {
										...
										if (ghg === "Online" && (syllabusId === "Cambridge" || syllabusId === "Pearson Edexcel")) {
											amountTopay = '5625'; // or button.innerHTML = 'Submit';
					...
					case 'sixTo10Package':
                        ...
                        case 'apexPackage':
											alert('Apex Package selected');
						
											var amountTopay;
											var typePackage = 'Apex Package';
						
											if (ghg === "Online" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
												amountTopay = '4860'; // amount to pay;
											}
											else {
												if (ghg === "Online" && (syllabusId === "IB")) {
													amountTopay = '5400'; // amount to pay;
												}
													...
													if (ghg === "In Person" && (syllabusId === "IEB" || syllabusId === "CAPs")) {
														...
														if (ghg === "In Person" && ( syllabusId === "IB")) {
															amountTopay = '10620'; // amount to pay;
														}
														
														else {
															if (ghg === "Online" && (syllabusId === "Cambridge" || syllabusId === "Pearson Edexcel")) {
																amountTopay = '7020'; // amount to pay;
															}
											...
											const datat = combineFormData();
						
											const sendDatat = {
												...datat, // Spread the existing data
												amount: amountTopay, package: typePackage
											};
    ...
    apexPackage.addEventListener('click', handleButtonClick);
